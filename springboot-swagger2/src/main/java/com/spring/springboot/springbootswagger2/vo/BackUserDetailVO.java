 ...
 */
@Data
@ApiModel(value = "backUserDetailVO", description="员工详细信息")
public class BackUserDetailVO implements Serializable {
    ...
    @ApiModelProperty(name = "员工角色", value = "员工角色的id", required = true)
    private Integer roleId;
    @ApiModelProperty(name = "角色名称", value = "店长", required = true)
